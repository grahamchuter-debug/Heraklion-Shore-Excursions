#!/usr/bin/env node
/**
 * Import Heraklion cruise ship schedules from CSV into the site's JSON data file.
 *
 * Usage:  node scripts/import-schedules.mjs
 *
 * Source:  data/schedule-sources/heraklion.csv
 * Output:  src/data/imported-schedules/heraklion.json
 *
...
const SOURCE = resolve(ROOT, "data/schedule-sources/heraklion.csv");
const OUTPUT = resolve(ROOT, "src/data/imported-schedules/heraklion.json");
