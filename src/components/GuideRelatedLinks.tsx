    ...
    <section className="rounded-xl border border-slate-200 bg-slate-50 p-6">
      ...
      <ul className="mt-4 space-y-2 text-sm">
        <li>
          ...
          <span className="text-slate-600"> — where ships dock, walking, taxis, weather</span>
        </li>
        <li>
        ...
        <li>
          <Link href="/cruise-ship-schedules" className="font-medium text-blue-800 hover:underline">
