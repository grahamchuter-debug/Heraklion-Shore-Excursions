    ...
    <footer className="mt-auto border-t border-slate-200 bg-slate-900 text-slate-300">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm leading-relaxed">
            ...
            {GEO_LABEL} — Knossos, the Archaeological Museum, the Venetian old
            town, beaches, and confident return-to-ship planning.
          </p>
          <Link
            href="/enquire"
      ...
      <div className="border-t border-slate-800">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-6 text-xs text-slate-500 sm:flex-row sm:justify-between">
          ...
          <p>heraklionshoreexcursions.com · Heraklion Cruise Port · Crete, Greece</p>
        </div>
      </div>
    </footer>
  );
