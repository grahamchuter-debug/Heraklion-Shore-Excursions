...
export async function generateMetadata({
  ...
  if (year) {
    return pageMetadata({
      title: `Heraklion Cruise Ship Schedule ${year}`,
      description: `Heraklion, Crete cruise ship arrivals and departures for ${year}. Plan your shore excursions around published port times.`,
      path: yearPath(year),
    });
  }
  ...
  if (monthKey) {
    ...
    return pageMetadata({
      title: `Heraklion Cruise Ship Schedule — ${label}`,
      description: `Heraklion, Crete cruise ship schedule for ${label} — arrival and departure times for port-day planning.`,
      ...
      <>
        <JsonLd
          data={[
            ...
            webPageSchema({
              title: `Heraklion Cruise Ship Schedule ${year}`,
              description: `Heraklion cruise ship calls throughout ${year}.`,
              path: yearPath(year),
            }),
          ]}
        />
        <div className="mx-auto max-w-6xl px-4 py-10">
          ...
          <PageHero
            ...
            title={`Heraklion — ${year} cruise schedule`}
            subtitle={`Ship calls at Heraklion throughout ${year}. Browse by month or view the full year below.`}
          />
            ...
            {entries.length === 0 && (
              <div className="rounded-xl border border-amber-200 bg-amber-50 p-6">
                ...
                <p className="mt-2 text-sm text-amber-900">
                  We are importing verified {year} ship calls for Heraklion. Check
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({
            title: `Heraklion Cruise Ship Schedule — ${label}`,
            description: `Heraklion cruise ship calls for ${label}.`,
            path: monthPath(key),
          }),
        ]}
      />
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <PageHero
          eyebrow="Ship schedule"
          title={`Heraklion — ${label}`}
          subtitle={`Cruise ship calls for ${label}. Confirm all-aboard times with your cruise line before booking excursions.`}
        />
