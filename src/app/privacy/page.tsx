...
export const metadata: Metadata = pageMetadata({
  title: "Privacy Policy — Heraklion Shore Excursions",
  description:
    "How Heraklion Shore Excursions handles personal data submitted through enquiries, and your privacy rights.",
  path,
});
        ...
        <div className="mt-10 space-y-10">
          ...
          <GuideSection title="How we use your information">
            <p>
              ...
              recommend suitable shore excursions in Heraklion. We do not sell
              your personal data. We may share relevant details with trusted local
              excursion operators only where necessary to answer your enquiry.
            </p>
          </GuideSection>
