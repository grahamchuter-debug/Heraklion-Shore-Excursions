...
export const metadata: Metadata = pageMetadata({
  title: "Terms of Use — Heraklion Shore Excursions",
  description:
    "The terms governing use of the Heraklion Shore Excursions website, including our information-only role and limitation of liability.",
  path,
});
        ...
        <div className="mt-10 space-y-10">
          <GuideSection title="About this website">
            <p>
              ...
              cruise passengers visiting Heraklion, Crete. By using this website
